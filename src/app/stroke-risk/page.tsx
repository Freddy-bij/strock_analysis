          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• This assessment is for educational purposes and should not replace professional medical advice</li>
                <li>• Please consult with your healthcare provider for proper diagnosis and treatment</li>
                <li>• Regular health check-ups are essential for accurate stroke risk assessment</li>
                <li>• Results are based on the information you provide and current medical guidelines</li>
              </ul>
            </div>
          </div>
        </div>
